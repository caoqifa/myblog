<template>
  <div id="Home">
    ...
    <article class="hello">
      <h2>HELLO!</h2>
      <p class="des">
        你好！欢迎来到我的博客！我是一名有点肾虚的WEB前端攻城狮，热衷于研究JavaScript、NodeJs、Vue、React、WebGL、Flutter、Electron……这是我的主页！我会在这里发表一些不成熟的技术文章，记录一些沙雕的日常。博客目前使用的是Vue
        + Nuxt + Element + Node + Express + MongoDB搭建的
      ...
      <div class="content" v-if="hotArticle.length">
        <div class="left">
          ...
          <div class="art">
            ...
            <p>{{hotArticle[1]?hotArticle[1].title:hotArticle[0].title}}</p>
            <div class="cover">
        ...
        <div class="right">
          <div class="art">
            ...
            <p>{{hotArticle[2]?hotArticle[2].title:hotArticle[1].title}}</p>
            <div class="cover">
              <a :href="`/article/${hotArticle[2]?hotArticle[2]._id:hotArticle[1]._id}`" target="_blank">
                <p>Tag: HTML</p>
                <p>View More</p>
              </a>
            </div>
    ...
    <article class="work">
      ...
      <ul>
        <li>
          ...
          <div class="right">
            <p class="company">成功是一个长期累积的过程，一夜成名瞬间暴富在现实中或许存在，但几率很小，如果想真真切切的触摸到成功，那么就要随时把握好机会，从小事做起，从一点一滴做起，命运是每一天生活的累积，小事情决定大成就。</p>
          </div>
        </li>
      </ul>
    </article>
